	...
	public boolean onCommand(CommandSender sender, Command command,
		...
		if (!com.canBeConsole()
			...
			sender.sendMessage(ChatColor.RED
					+ Messages
							.getString(
									InfoSigns.pluginName
											+ ".commands.base.noconsole", "command", "/" + label + " " + subCommand)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			return true;
		}
		if (!com.canBeCommandBlock() && sender instanceof BlockCommandSender) {
			sender.sendMessage(ChatColor.RED
					+ Messages
							.getString(
									InfoSigns.pluginName
											+ ".commands.base.nocommandblock", "command", "/" + label + " " + subCommand)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			return true;
		}
		...
		if (com.getPermission() != null
			...
			sender.sendMessage(ChatColor.RED
					+ Messages
							.getString(
									InfoSigns.pluginName
											+ ".commands.base.nopermission", "command", "/" + label + " " + subCommand)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			return true;
		}
		...
		if (!com.onCommand(sender, subCommand, subArgs)) {
			...
			usageString = ChatColor.RED
					+ Messages.getString(InfoSigns.pluginName
							+ ".commands.base.usage", "usage", usageString); //$NON-NLS-1$ //$NON-NLS-2$
		...
		if (subcommand != null) {
			sender.sendMessage(ChatColor.RED
					+ Messages
							.getString(
									InfoSigns.pluginName
											+ ".commands.base.unknowncommand", "command", ChatColor.RESET + "/" + label + " " + ChatColor.GOLD + subcommand)); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			sender.sendMessage(Messages.getString(InfoSigns.pluginName
					+ ".commands.base.validcommands")); //$NON-NLS-1$
		} else {
			sender.sendMessage(ChatColor.RED
					+ Messages
							.getString(
									InfoSigns.pluginName
											+ ".commands.base.nocommand", "command", ChatColor.RESET + "/" + label + ChatColor.GOLD + " <command>")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			sender.sendMessage(Messages.getString(InfoSigns.pluginName
					+ ".commands.base.validcommands")); //$NON-NLS-1$
		}
	...
	private class InternalHelp implements ICommand {
		...
		public String getDescription() {
			return Messages.getString(InfoSigns.pluginName
					+ ".commands.base.help.description"); //$NON-NLS-1$
		}
		...
		public boolean onCommand(CommandSender sender, String label,
			...
			sender.sendMessage(ChatColor.GOLD
					+ Messages.getString(InfoSigns.pluginName
							+ ".commands.base.help.commands")); //$NON-NLS-1$
